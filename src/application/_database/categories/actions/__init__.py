from src.application._database.categories.actions.purchases.main_purchase import purchase_accounts, purchase
from src.application._database.categories.actions.actions_add import add_translation_in_category, add_category
from src.application._database.categories.actions.actions_delete import delete_category, delete_translate_category
from src.application._database.categories.actions.actions_get import get_category_by_category_id, \
...
from src.application._database.categories.actions.actions_update import update_category, update_category_translation
from src.application._database.categories.actions.products.accounts.actions_add import add_product_account, \
    add_translation_in_sold_account, add_account_storage, add_sold_account, add_deleted_accounts
from src.application._database.categories.actions.products.accounts.actions_delete import delete_product_account, \
    delete_sold_account, delete_product_accounts_by_category
from src.application._database.categories.actions.products.accounts.actions_get import get_product_account_by_category_id, \
...
from src.application._database.categories.actions.products.accounts.actions_update import update_account_storage, \
    update_tg_account_media
from src.application._database.categories.actions.products.universal.action_delete import delete_prod_universal, \
    delete_sold_universal, delete_product_universal_by_category
from src.application._database.categories.actions.products.universal.action_update import update_universal_storage
from src.application._database.categories.actions.products.universal.actions_add import add_translate_in_universal_storage, \
