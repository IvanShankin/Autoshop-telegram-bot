...
# from src.application._database.categories.actions import get_account_service
# from src.application._database.users.categories import Users
...
#             except Exception:
#                 pass
#             await callback.answer(get_text(user.language, "admins_editor_services","The service_acc is no longer available"), show_alert=True)
#             return
#
#         await send_message(chat_id=user.user_id, message=get_text(user.language, "admins_editor_services","The service_acc is no longer available"))
#         return
#
#     message = get_text(
#         user.language,
