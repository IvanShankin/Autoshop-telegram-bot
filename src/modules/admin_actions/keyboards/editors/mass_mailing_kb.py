...
def editor_message_mailing_kb(language: str, button_url: str | None = None):
    ...
    keyboard.row(InlineKeyboardButton(text=get_text(language, 'keyboard', "Start mailing"), callback_data=f"confirm_start_mailing"))
    keyboard.row(InlineKeyboardButton(text=get_text(language, 'keyboard', "Change Photo"), callback_data=f"change_mailing_photo"))
    keyboard.row(InlineKeyboardButton(text=get_text(language, 'keyboard', "Change text"), callback_data=f"change_mailing_text"))
    keyboard.row(InlineKeyboardButton(text=get_text(language, 'keyboard', "Change button url"), callback_data=f"change_mailing_btn_url"))
    keyboard.row(InlineKeyboardButton(text=get_text(language, 'keyboard', "Back"), callback_data=f"admin_mailing"))
...
def confirm_start_mailing_kb(language: str):
    return InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text=get_text(language, 'keyboard',"Confirm"), callback_data=f'start_mass_mailing'),],
        [InlineKeyboardButton(text=get_text(language, 'keyboard','Back'), callback_data=f'editor_mes_mailing'),]
    ])
...
def change_mailing_photo_kb(language: str, current_show_image: bool):
    return InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(
            text=get_text(language, 'keyboard', "{indicator} Show").format(indicator='🟢' if current_show_image else '🔴'),
...
def change_mailing_text_kb(language: str):
    return InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text=get_text(language, 'keyboard',"Hints to the text"), callback_data=f'open_mailing_tip'),],
        [InlineKeyboardButton(text=get_text(language, 'keyboard','Back'), callback_data=f'editor_mes_mailing'),]
    ])
...
def change_mailing_btn_url_kb(language: str):
    return InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text=get_text(language, 'keyboard',"Delete"), callback_data=f'delete_mailing_btn_url'),],
        [InlineKeyboardButton(text=get_text(language, 'keyboard','Back'), callback_data=f'editor_mes_mailing'),]
    ])
...
def back_in_change_mailing_text_kb(language: str):
    return InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text=get_text(language, 'keyboard','Back'), callback_data=f'change_mailing_text'),]
    ])
...
def back_in_admin_mailing_kb(language: str):
    return InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text=get_text(language, 'keyboard','Back'), callback_data=f'admin_mailing'),]
    ])