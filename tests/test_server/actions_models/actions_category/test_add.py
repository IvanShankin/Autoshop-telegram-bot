...
async def test_add_translation_in_category(replacement_needed_modules, create_category):
    from src.application._database.categories.actions import add_translation_in_category
...
async def test_add_category(replacement_needed_modules):
    from src.application._database.categories.actions import add_category
