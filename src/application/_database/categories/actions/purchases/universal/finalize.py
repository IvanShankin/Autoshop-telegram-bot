...
from src.application._database.categories.actions.purchases.universal.cancel import cancel_purchase_universal_one, \
    cancel_purchase_universal_different
from src.application._database.categories.events.schemas import UniversalProductData, \
