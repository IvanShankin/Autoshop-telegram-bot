from src.services._database.categories.actions.purchases.main_purchase import purchase_accounts, purchase
from src.services._database.categories.actions.actions_add import add_translation_in_category, add_category
from src.services._database.categories.actions.actions_delete import delete_category, delete_translate_category
...
from src.services._database.categories.actions.actions_update import update_category, update_category_translation
from src.services._database.categories.actions.products.accounts.actions_add import add_product_account, \
...
from src.services._database.categories.actions.products.accounts.actions_update import update_account_storage, \
    update_tg_account_media
from src.services._database.categories.actions.products.universal.action_delete import delete_prod_universal, \
...
from src.services._database.categories.actions.products.universal.actions_add import add_translate_in_universal_storage, \
