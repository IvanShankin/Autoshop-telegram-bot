...
from src.models.create_models.discounts import CreateActivatedPromoCodeDTO
...
class ActivatedPromoCodesService:
    ...
    async def create_activate_promo_code(self, data: CreateActivatedPromoCodeDTO) -> ActivatedPromoCodesDTO:
