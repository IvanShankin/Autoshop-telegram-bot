...
async def handler_new_replenishment(new_replenishment: NewReplenishment):
    ...
    try:
        ...
        async with get_db() as session_db:
            ...
            # тут отправить сообщение, что всё успешно (в канал и пользователю)
    except Exception as e:
        pass
        # тут отправить сообщение, что всё плохо (в канал и пользователю)
        # если есть money_credited, то деньги дошли пользователю
        # сделаем лог в файл