...
async def test_safe_get_category_not_found_with_callback(
    ...
    """
    from src.modules.admin_actions.handlers.editor_acc_categories_handlers import safe_get_category
...
async def test_show_category_sends_new_message(
    ...
    from src.modules.admin_actions.handlers.editor_acc_categories_handlers import show_category
...
async def test_show_category_update_data_edit(
    ...
    from src.modules.admin_actions.handlers.editor_acc_categories_handlers import show_category_update_data
...
async def test_update_data_incorrect_value(
    ...
    from src.modules.admin_actions.handlers.editor_acc_categories_handlers import update_data
...
async def test_add_acc_category_name_prompts_next_language(
    ...
    """
    from src.modules.admin_actions.handlers.editor_acc_categories_handlers import add_acc_category_name
...
async def test_service_update_index_updates_storage_flag(
    ...
    """
    from src.modules.admin_actions.handlers.editor_acc_categories_handlers import acc_category_update_storage
...
async def test_delete_acc_category_success_edit_message(
    ...
    """
    from src.modules.admin_actions.handlers.editor_acc_categories_handlers import delete_acc_category
...
async def test_update_category_image_non_image_document(
    ...
    """
    from src.modules.admin_actions.handlers.editor_acc_categories_handlers import update_category_image
